<template>
  <div v-show="showPhotos" v-for="date in keyDate" :key="date"
    ...
    <div>
      ...
      <div :class="photoClass(date)" class="mt-3 sm:gap-5 lg:gap-8 xl:gap-10 space-y-3 sm:space-y-5 lg:space-y-8 xl:space-y-10">
  ...
  <div class="flex justify-center">
    <InfiniteLoading @infinite="load">
      <template #spinner>
        <span>
          <svg class="animate-spin -ml-1 mr-3 w-10 h-10 sm:h-16 sm:w-16 text-black/80" viewBox="0 0 24 24">
